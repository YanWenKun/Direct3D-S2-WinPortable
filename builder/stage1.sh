...
cd "$workdir"
curl -sSL \
https://github.com/astral-sh/python-build-standalone/releases/download/20250529/cpython-3.12.10+20250529-x86_64-pc-windows-msvc-install_only.tar.gz \
    -o python.tar.gz
...
$pip_exe install --no-deps utils3d
